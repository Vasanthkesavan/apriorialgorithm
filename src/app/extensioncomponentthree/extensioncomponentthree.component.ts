...
var data = require('../../../database/shoprite.json');

@Component({
  selector: 'app-extensioncomponentthree',
  templateUrl: './extensioncomponentthree.component.html',
  styleUrls: ['./extensioncomponentthree.component.css']
})
export class ExtensioncomponentthreeComponent implements OnInit {
  data: any[];
  title: string;
  constructor() { }
