...
var data = require('../../../database/wholefoods.json');

@Component({
  selector: 'app-extensioncomponentfive',
  templateUrl: './extensioncomponentfive.component.html',
  styleUrls: ['./extensioncomponentfive.component.css']
})
export class ExtensioncomponentfiveComponent implements OnInit {
  data: any[];
  title: string;
  constructor() { }
