...
var data = require('../../../database/walmart.json');

@Component({
  selector: 'app-extensioncomponentfour',
  templateUrl: './extensioncomponentfour.component.html',
  styleUrls: ['./extensioncomponentfour.component.css']
})
export class ExtensioncomponentfourComponent implements OnInit {
  data: any[];
  title: string;
  constructor() { }
